...
ds = dataset(['../results/result.xlsx'],
                variables=['wind','solar','H2','battery','co2_emission','system_cost'],
                m = 50000)

#%%
ds.interrior_points = ds.df_sum_var.values
#%% Figure 1 - Topology
...
fig = plot_network('../inter_results/network_c0_s1.nc',
...
def plot_contour(x,y,plot_range=None):
    ...
    line_smoothing=1.3,
    showscale = False,
    contours=dict(start=1,end=251,size=50),
